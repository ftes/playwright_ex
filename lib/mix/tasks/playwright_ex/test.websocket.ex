defmodule Mix.Tasks.PlaywrightEx.Test.Websocket do
  ...
  ## Usage
      ...
      mix playwright_ex.test.websocket
      mix playwright_ex.test.websocket --warnings-as-errors
      mix playwright_ex.test.websocket test/specific_test.exs
  """
